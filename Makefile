...
install:
	...
	@echo "**************************************************************"
	@echo "Now set your package options in the file /etc/yaps.rc"
	@echo "Either manually or by using 'yaps --setup'"
	...
	@echo "https://github.com/KeithDHedger/yapsBuilds"
	@echo "Place yapsBuildScripts and LFSScripts in / ."
	@echo "If you place them elsewhere set BUILDSCRIPTS in /etc/yaps.rc"
	@echo
